<template>
  <nav class="bg-gray-800">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        <div class="absolute inset-y-0 left-0 flex items-center sm:hidden">
          <!-- Mobile menu button-->
          <NavbarMobileButton :active="opened" @toggle="updateOpened" />
        </div>
    ...
    -->
    <NavbarMobileMenu v-if="opened" />
  </nav>
</template>

<script lang="ts">
import { defineComponent, ref } from 'vue'
import NavbarMobileButton from './children/NavbarMobileButton.component.vue';
import NavbarMobileMenu from './children/NavbarMobileMenu.component.vue'
...
export default defineComponent({
  ...
  setup () {
    ...
    const updateOpened = (isOpen: boolean) => opened.value = isOpen
